\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.14\textwidth}>{\raggedright\arraybackslash}p{0.27\textwidth}>{\raggedright\arraybackslash}p{0.27\textwidth}>{\raggedright\arraybackslash}X@{}}
    ...
    Qualität & Tests, Profilmatrix, Buildpfade und Release-Gate sind im
      Abnahmeprotokoll erfasst. & Aktuelle Tooling-, Desktopprofil- und
      Windows-Jobs schlagen fehl; Branch Protection ist nicht nachgewiesen. &
      Gute lokale Prüfbasis, aber kein durchgehend grüner Remote-Nachweis. \\

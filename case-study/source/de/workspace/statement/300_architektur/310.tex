...
Datenbank speichert Daten dauerhaft. Die hier gezeigte optionale
PostgreSQL-Datenbank wird nur vom Backend angesprochen. Deployment bedeutet,
diese Bausteine in einer
...
Die Quality-Governance läuft beim Entwickeln oder in CI. Sie liest
Projektdateien und meldet Verstöße, gehört aber nicht zur später laufenden
Anwendung. Das Frontend sendet deshalb keine Daten an das Quality Gate, und das
Backend ruft es im Produktbetrieb nicht auf. Es ist eine Prüfschicht außerhalb
des normalen Laufzeitdatenflusses.

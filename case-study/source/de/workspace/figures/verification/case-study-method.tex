\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=6mm]
    \node[casePrimary,minimum width=78mm] (capture) {Template erfassen};
    ...
    \node[caseBox,minimum width=78mm,below=of profiles] (tooling) {Tooling untersuchen};
    \node[caseBox,minimum width=78mm,below=of tooling] (verification) {Verifikationsdaten auswerten};
